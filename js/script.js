...
window.onload = function()
{
	...
	for(var i = 0; i <= 9; i++)
	{
		...
		if(i >= 1 && i <= 4)
		{
			...
			{
				if(operacion.length != 0)// Tiene que existir un número antes...
				{					
					if(operacion.indexOf(operaciones.operador) != null )//No pueden existir dos operadores seguidos...
					{
						if(operacion.length-1 != operaciones.operador)//No puede quedar un operador al final...
						{
